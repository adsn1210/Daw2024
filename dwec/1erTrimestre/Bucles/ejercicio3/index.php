<?php
#3. Escriba un programa que dibuje entre 1 y 10 círculos de colores (al azar) en una fila de tabla.
...
<style>
        ...
        .color1 { fill: hwb(0 0% 0%); }
        .color2 { fill: hwb(60 0% 0%); }
        .color3 { fill: hwb(120 0% 0%); }
        .color4 { fill: hwb(180 0% 0%); }
        .color5 { fill: hwb(240 0% 0%); }
        .color6 { fill: hwb(300 0% 0%); }
        .color7 { fill: hwb(360 0% 0%); }
    </style>
